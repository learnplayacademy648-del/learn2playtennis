...
import fourCourt from "../assets/about/fourCourt.jpg";
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 grid md:grid-cols-2 gap-16 items-center">
        ...
        >
          <div className="overflow-hidden rounded-3xl shadow-xl relative h-[400px] md:h-[500px] lg:h-[550px]">
            <img
              src={fourCourt}
              alt="Tennis courts at Learn2PlayTennis"
              className="object-cover w-full h-full object-center transition-transform duration-700 group-hover:scale-105"
            />
            <div className="absolute inset-0 bg-gradient-to-tr from-black/30 via-transparent to-transparent rounded-3xl" />
          </div>
